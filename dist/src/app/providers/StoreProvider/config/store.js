...
export function createReduxStore(initialState, asyncReducers) {
    var _a;
    var rootReducers = __assign(__assign({}, asyncReducers), (_a = { counter: counterReducer, user: userReducer, scrollRecovery: scrollRecoveryReducer }, _a[rtkApi.reducerPath] = rtkApi.reducer, _a));
