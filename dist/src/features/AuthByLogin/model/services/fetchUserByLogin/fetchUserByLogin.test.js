...
describe('fetchUserByLogin', function () {
    test('success login', function () { return __awaiter(void 0, void 0, void 0, function () {
        var userValue, thunk, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userValue = { id: '1', login: 'login' };
                    thunk = new TestAsyncThunk(fetchUserByLogin);
                    thunk.api.post.mockReturnValue(Promise.resolve({ data: userValue }));
                    return [4 /*yield*/, thunk.CallThunk({ login: 'login', password: 'password' })];
                case 1:
                    result = _a.sent();
