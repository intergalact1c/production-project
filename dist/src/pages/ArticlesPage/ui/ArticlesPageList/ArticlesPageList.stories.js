...
export default {
    title: 'pages/ArticlesPage/ArticlesPageList',
    component: ArticlesPageList,
    argTypes: {
        backgroundColor: { control: 'color' },
    },
};
var Template = function (args) { return _jsx(ArticlesPageList, __assign({}, args), void 0); };
...
arr.forEach(function (item, index) {
    ...
    ids.push(id);
    entities[id] = __assign(__assign({}, article), { id: id });
});
var initialState = {
    articlesPage: {
        ids: ids,
