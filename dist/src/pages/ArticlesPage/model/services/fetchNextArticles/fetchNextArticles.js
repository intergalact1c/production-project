...
export var fetchNextArticles = createAsyncThunk('articles/fetchNextArticles', function (_, thunkApi) { return __awaiter(void 0, void 0, void 0, function () {
    var getState, dispatch, pageNumber, hasMore, isLoading;
    return __generator(this, function (_a) {
        getState = thunkApi.getState, dispatch = thunkApi.dispatch;
        pageNumber = getArticlesPageNumber(getState());
