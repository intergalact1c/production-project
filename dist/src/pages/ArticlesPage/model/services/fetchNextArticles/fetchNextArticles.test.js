...
describe('fetchNextArticles', function () {
    test('success', function () { return __awaiter(void 0, void 0, void 0, function () {
        var thunk;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    thunk = new TestAsyncThunk(fetchNextArticles, {
                        // initialState
                        articlesPage: {
                            page: 2,
                            ids: [],
    ...
    test('fetchNextArticles not called', function () { return __awaiter(void 0, void 0, void 0, function () {
        var thunk;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
