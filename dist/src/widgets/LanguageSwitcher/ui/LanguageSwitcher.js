...
export var LanguageSwitcher = memo(function (_a) {
    ...
    return (_jsx(Button, __assign({ className: classNames('', {}, [className]), theme: ButtonTheme.BACKGROUND_INVERTED, onClick: toggle }, { children: short ? t('Короткий язык') : t('Язык') }), void 0));
});
