...
- `npm run postinstall` - Скрипт автоматического применения патчей после установки зависимостей
...
*eslint-plugin-ulbi-tv-plugin*, который содержит 3 правила:
...
- [AuthByLogin](/src/features/AuthByLogin)
